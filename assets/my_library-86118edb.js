import{r as i,c as C,d as $,s as h,b as w}from"./switcher-89ad6a3e.js";const m="MY_LIBRARY";let f={},d=null,L=null;i.libraryContainer.addEventListener("click",O);function S(e){if(e.genres){const{poster_path:t,title:o,id:n,genres:r,release_date:s,vote_average:a}=e,c=r.map(p=>p.name),g=s?s.split("-")[0]:"";return`
