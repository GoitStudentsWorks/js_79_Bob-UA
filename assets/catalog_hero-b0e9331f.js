...
.hero-text-container {
  ...
  @media (min-device-pixel-ratio: 2),
   ...
   <h1 class="text-modal-oops">
    ...
    <div class="camera"></div>`}const F=({backdrop_path:e,title:t,vote_average:r,overview:i,id:a})=>` <div class="hero-content"><div class="hero-text-container">
    ...
    <img class="star-rating-hero" src="${I(r)}" alt="raiting" />
      ...
      <div class="img-container"><img class="hero-img" src="${q}${e}" alt="${t}"></div>
